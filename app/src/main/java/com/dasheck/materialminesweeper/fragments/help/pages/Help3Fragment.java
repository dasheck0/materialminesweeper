 ...
 */
public class Help3Fragment extends PageFragment {
  ...
  @Override public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    text.addPiece(new BabushkaText.Piece.Builder("Long press").textColor(accentColor).build());
    text.addPiece(new BabushkaText.Piece.Builder(" a tile to mark it as a mine").textColor(textColor).build());
    text.display();
  }
