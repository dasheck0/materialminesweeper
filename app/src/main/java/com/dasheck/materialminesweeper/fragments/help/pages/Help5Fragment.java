 ...
 */
public class Help5Fragment extends PageFragment {
  ...
  @Override public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    text.addPiece(new BabushkaText.Piece.Builder("When you reveal a mine you ").textColor(textColor).build());
    text.addPiece(new BabushkaText.Piece.Builder("loose").textColor(accentColor).build());
    text.display();
  }
